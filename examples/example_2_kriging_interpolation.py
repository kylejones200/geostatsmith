...
# Remove top and right spines
ax1.set_title("Kriging Predictions", fontsize.spines['top'].set_visible(False)
ax1.set_title("Kriging Predictions", fontsize.spines['right'].set_visible(False)
...
# Remove top and right spines
ax2.set_xlabel("X", fontsize.spines['top'].set_visible(False)
ax2.set_xlabel("X", fontsize.spines['right'].set_visible(False)
ax2.set_ylabel("Y", fontsize=12)
# Remove top and right spines
ax2.set_ylabel("Y", fontsize.spines['top'].set_visible(False)
ax2.set_ylabel("Y", fontsize.spines['right'].set_visible(False)
ax2.set_title("Kriging Variance (Uncertainty)", fontsize=14, fontweight="bold")
# Remove top and right spines
ax2.set_title("Kriging Variance (Uncertainty)", fontsize.spines['top'].set_visible(False)
ax2.set_title("Kriging Variance (Uncertainty)", fontsize.spines['right'].set_visible(False)
...
ax3.scatter(z, cv_pred, alpha.spines['right'].set_visible(False)
# Plot 1:1 line
...
ax3.plot([min_val, max_val], [min_val, max_val], "r--", linewidth.spines['right'].set_visible(False)
ax3.set_xlabel("True Values", fontsize=12)
# Remove top and right spines
ax3.set_xlabel("True Values", fontsize.spines['top'].set_visible(False)
ax3.set_xlabel("True Values", fontsize.spines['right'].set_visible(False)
ax3.set_ylabel("Predicted Values (CV)", fontsize=12)
# Remove top and right spines
ax3.set_ylabel("Predicted Values (CV)", fontsize.spines['top'].set_visible(False)
ax3.set_ylabel("Predicted Values (CV)", fontsize.spines['right'].set_visible(False)
ax3.set_title(
