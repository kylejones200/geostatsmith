...
ax9.scatter(V, U, alpha.spines['right'].set_visible(False)
corr = np.corrcoef(V, U)[0, 1]
ax9.set_xlabel('V (ppm)', fontsize=11)
# Remove top and right spines
ax9.set_xlabel('V (ppm)', fontsize.spines['top'].set_visible(False)
ax9.set_xlabel('V (ppm)', fontsize.spines['right'].set_visible(False)
ax9.set_ylabel('U (ppm)', fontsize=11)
# Remove top and right spines
ax9.set_ylabel('U (ppm)', fontsize.spines['top'].set_visible(False)
ax9.set_ylabel('U (ppm)', fontsize.spines['right'].set_visible(False)
ax9.set_title(f'V vs U Cross-plot (ρ={corr:.3f})', fontweight='bold', fontsize=11)
# Remove top and right spines
ax9.set_title(f'V vs U Cross-plot (ρ.spines['top'].set_visible(False)
ax9.set_title(f'V vs U Cross-plot (ρ.spines['right'].set_visible(False)
...
ax10.set_title('V Distribution', fontweight.spines['right'].set_visible(False)
...
ax11.set_title('U Distribution', fontweight.spines['right'].set_visible(False)
...
for direction in dirs:
 ...
 # Remove top and right spines
 ax3.plot(lags_dir[valid], gamma_dir[valid], 'o-', label.spines['top'].set_visible(False)
 ax3.plot(lags_dir[valid], gamma_dir[valid], 'o-', label.spines['right'].set_visible(False)

ax3.set_xlabel('Distance (h)', fontsize=11)
# Remove top and right spines
ax3.set_xlabel('Distance (h)', fontsize.spines['top'].set_visible(False)
ax3.set_xlabel('Distance (h)', fontsize.spines['right'].set_visible(False)
ax3.set_ylabel('γ(h)', fontsize=11)
# Remove top and right spines
ax3.set_ylabel('γ(h)', fontsize.spines['top'].set_visible(False)
ax3.set_ylabel('γ(h)', fontsize.spines['right'].set_visible(False)
ax3.set_title('Directional Variograms', fontweight='bold', fontsize=12)
# Remove top and right spines
ax3.set_title('Directional Variograms', fontweight.spines['top'].set_visible(False)
ax3.set_title('Directional Variograms', fontweight.spines['right'].set_visible(False)
ax3.legend()
...
ax4.set_title('Variogram for U', fontweight.spines['right'].set_visible(False)
...
ax5.plot(lags, gamma, 'o-', label.spines['right'].set_visible(False)
ax5.plot(lags_u, gamma_u, 's-', label='U (PCE)', linewidth=2, markersize=7)
# Remove top and right spines
ax5.plot(lags_u, gamma_u, 's-', label.spines['top'].set_visible(False)
ax5.plot(lags_u, gamma_u, 's-', label.spines['right'].set_visible(False)
ax5.set_xlabel('Distance (h)', fontsize=11)
# Remove top and right spines
ax5.set_xlabel('Distance (h)', fontsize.spines['top'].set_visible(False)
ax5.set_xlabel('Distance (h)', fontsize.spines['right'].set_visible(False)
ax5.set_ylabel('γ(h)', fontsize=11)
# Remove top and right spines
ax5.set_ylabel('γ(h)', fontsize.spines['top'].set_visible(False)
ax5.set_ylabel('γ(h)', fontsize.spines['right'].set_visible(False)
ax5.set_title('Variogram Comparison', fontweight='bold', fontsize=12)
# Remove top and right spines
ax5.set_title('Variogram Comparison', fontweight.spines['top'].set_visible(False)
ax5.set_title('Variogram Comparison', fontweight.spines['right'].set_visible(False)
ax5.legend()
...
# Remove top and right spines
ax6.text(0.1, 0.5, aniso_text, transform.spines['top'].set_visible(False)
ax6.text(0.1, 0.5, aniso_text, transform.spines['right'].set_visible(False)
 fontsize=12, verticalalignment='center',
 bbox=dict(boxstyle='round', facecolor='lightblue', alpha=0.8))
ax6.axis('off')
ax6.set_title('Anisotropy Parameters', fontweight='bold', fontsize=12)
# Remove top and right spines
ax6.set_title('Anisotropy Parameters', fontweight.spines['top'].set_visible(False)
ax6.set_title('Anisotropy Parameters', fontweight.spines['right'].set_visible(False)
...
# Remove top and right spines
axes[0, 0].set_title('V - Data Locations', fontweight.spines['top'].set_visible(False)
axes[0, 0].set_title('V - Data Locations', fontweight.spines['right'].set_visible(False)
...
axes[0, 1].set_title('U - Data Locations', fontweight.spines['right'].set_visible(False)
...
axes[1, 0].set_title('V - Symbol Map (size ∝ value)', fontweight.spines['right'].set_visible(False)
...
axes[1, 1].set_title('U - Symbol Map (size ∝ value)', fontweight.spines['right'].set_visible(False)
