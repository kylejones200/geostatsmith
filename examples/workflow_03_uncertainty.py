...
def example_3_risk_assessment():
 ...
 logger.info(f" Recommend remediation: {n_remediate} cells ({n_remediate/len(x_pred)*100:.1f}%)")
 logger.info(f" Recommend no action: {n_no_action} cells ({n_no_action/len(x_pred)*100:.1f}%)")
