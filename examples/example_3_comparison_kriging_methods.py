...
logger.info("-" * 50)
logger.info(f"{'Simple Kriging':<20} {metrics_sk['rmse']:<10.4f} {metrics_sk['mae']:<10.4f} {metrics_sk['r2']:<10.4f}")
logger.info(f"{'Ordinary Kriging':<20} {metrics_ok['rmse']:<10.4f} {metrics_ok['mae']:<10.4f} {metrics_ok['r2']:<10.4f}")
logger.info(f"{'Universal Kriging':<20} {metrics_uk['rmse']:<10.4f} {metrics_uk['mae']:<10.4f} {metrics_uk['r2']:<10.4f}")
