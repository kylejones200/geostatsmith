...
for idx, (method_name, z_pred, var_pred, metrics) in enumerate(methods, 1):
    ...
    # Remove top and right spines
    ax2.scatter(x, y, s.spines['top'].set_visible(False)
    ax2.scatter(x, y, s.spines['right'].set_visible(False)
    ax2.set_title(f"{method_name} - Variance", fontsize=12, fontweight="bold")
    # Remove top and right spines
    ax2.set_title(f"{method_name} - Variance", fontsize.spines['top'].set_visible(False)
    ax2.set_title(f"{method_name} - Variance", fontsize.spines['right'].set_visible(False)
    ax2.set_xlabel("X")
    ax2.set_ylabel("Y")
