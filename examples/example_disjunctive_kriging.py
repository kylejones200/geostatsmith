...
def main():
    ...
    axes[0, 0].set_title("Original Data (Lognormal)").spines['right'].set_visible(False)
    axes[0, 0].set_xlabel("X")
    # Remove top and right spines
    axes[0, 0].set_xlabel("X").spines['top'].set_visible(False)
    axes[0, 0].set_xlabel("X").spines['right'].set_visible(False)
    ...
    axes[0, 1].scatter(.spines['right'].set_visible(False)
    ...
    axes[0, 1].set_title("Disjunctive Kriging Predictions").spines['right'].set_visible(False)
    axes[0, 1].set_xlabel("X")
    # Remove top and right spines
    axes[0, 1].set_xlabel("X").spines['top'].set_visible(False)
    axes[0, 1].set_xlabel("X").spines['right'].set_visible(False)
    ...
    axes[1, 0].scatter(.spines['right'].set_visible(False)
        x, y, c="white", s=20, alpha=0.6, edgecolors="black", linewidth=0.5
    )
    axes[1, 0].set_title("Prediction Variance")
    # Remove top and right spines
    axes[1, 0].set_title("Prediction Variance").spines['top'].set_visible(False)
    axes[1, 0].set_title("Prediction Variance").spines['right'].set_visible(False)
    axes[1, 0].set_xlabel("X")
    # Remove top and right spines
    axes[1, 0].set_xlabel("X").spines['top'].set_visible(False)
    axes[1, 0].set_xlabel("X").spines['right'].set_visible(False)
    ...
    axes[1, 1].scatter(z, cv_predictions, alpha.spines['right'].set_visible(False)
    ...
    axes[1, 1].plot([min_val, max_val], [min_val, max_val], "r--", label.spines['right'].set_visible(False)
    axes[1, 1].set_xlabel("Actual Values")
    # Remove top and right spines
    axes[1, 1].set_xlabel("Actual Values").spines['top'].set_visible(False)
    axes[1, 1].set_xlabel("Actual Values").spines['right'].set_visible(False)
    axes[1, 1].set_ylabel("Predicted Values")
    # Remove top and right spines
    axes[1, 1].set_ylabel("Predicted Values").spines['top'].set_visible(False)
    axes[1, 1].set_ylabel("Predicted Values").spines['right'].set_visible(False)
    ...
    axes[1, 1].set_title(f"Cross-Validation (R².spines['right'].set_visible(False)
    axes[1, 1].legend()
    # Remove top and right spines
    axes[1, 1].legend().spines['top'].set_visible(False)
    axes[1, 1].legend().spines['right'].set_visible(False)
