...
def gold_exploration_analysis(agdb_path, region_name='Iliamna'):
    ...
    axes[0].scatter(x, y, c.spines['right'].set_visible(False).spines['right'].set_visible(False)
    axes[0].set_title(f'Gold Sample Locations (n={len(au)})')
    # Remove top and right spines
    axes[0].set_title(f'Gold Sample Locations (n.spines['top'].set_visible(False)
    axes[0].set_title(f'Gold Sample Locations (n.spines['right'].set_visible(False)
    axes[0].set_xlabel('Longitude')
    # Remove top and right spines
    axes[0].set_xlabel('Longitude').spines['top'].set_visible(False)
    axes[0].set_xlabel('Longitude').spines['right'].set_visible(False)
    axes[0].set_ylabel('Latitude')
    # Remove top and right spines
    axes[0].set_ylabel('Latitude').spines['top'].set_visible(False)
    axes[0].set_ylabel('Latitude').spines['right'].set_visible(False)
    ...
    axes[0].set_ylabel('Latitude').spines['right'].set_visible(False).spines['right'].set_visible(False)
    ...
    axes[1].set_title('Kriged Gold Distribution').spines['right'].set_visible(False)
    axes[1].set_xlabel('Longitude')
    # Remove top and right spines
    axes[1].set_xlabel('Longitude').spines['top'].set_visible(False)
    axes[1].set_xlabel('Longitude').spines['right'].set_visible(False)
    axes[1].set_ylabel('Latitude')
    # Remove top and right spines
    axes[1].set_ylabel('Latitude').spines['top'].set_visible(False)
    axes[1].set_ylabel('Latitude').spines['right'].set_visible(False)
    ...
    axes[1].set_ylabel('Latitude').spines['right'].set_visible(False).spines['right'].set_visible(False)
    ...
    axes[2].set_title('Prediction Uncertainty (Std Dev)').spines['right'].set_visible(False)
    axes[2].set_xlabel('Longitude')
    # Remove top and right spines
    axes[2].set_xlabel('Longitude').spines['top'].set_visible(False)
    axes[2].set_xlabel('Longitude').spines['right'].set_visible(False)
    axes[2].set_ylabel('Latitude')
    # Remove top and right spines
    axes[2].set_ylabel('Latitude').spines['top'].set_visible(False)
    axes[2].set_ylabel('Latitude').spines['right'].set_visible(False)
    ...
    axes[2].set_ylabel('Latitude').spines['right'].set_visible(False).spines['right'].set_visible(False)
