...
ax5.scatter(x, y, c=V, cmap='viridis', s=60, edgecolors='white', linewidth=1.5, zorder=5)
...
ax7.scatter(x, y, c=V, cmap='viridis', s=60, edgecolors='white', linewidth=1.5, zorder=5)
...
ax8.scatter(x, y, c=V, cmap='viridis', s=60, edgecolors='white', linewidth=1.5, zorder=5)
...
ax9.scatter(x, y, c=V, cmap='viridis', s=60, edgecolors='white', linewidth=1.5, zorder=5)
...
ax11.hist(Mean_sgs.flatten(), bins=15, alpha=0.5, label='SGS E-type', density=True, edgecolor='black')
ax11.hist(Z_ok.flatten(), bins=15, alpha=0.5, label='OK', density=True, edgecolor='black')
