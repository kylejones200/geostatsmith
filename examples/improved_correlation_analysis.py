...
au_chem = chem_a[chem_a['PARAMETER'].str.contains('Au_', case=False, na=False)][['AGDB_ID', 'DATA_VALUE']].copy()
...
ax2.scatter(cu_log_porp, au_log_porp, alpha=0.5, s=15, c='steelblue', edgecolors='k', linewidths=0.3)
...
ax3.scatter(cu_log_anom, au_log_anom, alpha=0.5, s=20, c='coral', edgecolors='k', linewidths=0.3)
...
ax4.scatter(cu_log_best, au_log_best, alpha=0.6, s=25, c='darkgreen', edgecolors='k', linewidths=0.5)
...
bars = ax5.bar(approaches, r2_values, color=colors, alpha=0.7, edgecolor='black', linewidth=2)
ax5.set_ylabel('R² (Coefficient of Determination)', fontsize=11, fontweight='bold')
ax5.set_title('Correlation Strength Comparison\n(Higher is Better)', fontsize=12, fontweight='bold')
...
bars2 = ax6.bar(approaches, counts, color=colors, alpha=0.7, edgecolor='black', linewidth=2)
