...
print("=" * 70)
print("RECIPE 3: SPATIAL POINT PATTERN ANALYSIS")
print("=" * 70)
...
print(f"  Created 3 patterns with ~100 points each")
...
for pattern_name, (x, y) in patterns.items():
    ...
    print(f"\nNearest Neighbor Analysis:")
    print(f"  R index: {nn_results['R']:.3f}")
    print(f"  Z-score: {nn_results['z_score']:.3f}")
    print(f"  P-value: {nn_results['p_value']:.4f}")
    print(f"  Interpretation: {nn_results['interpretation']}")
    
    # Ripley's K
    ripley_results = ripley_k_function(x, y, n_distances=30)
    print(f"\nRipley's K Function:")
    print(f"  Interpretation: {ripley_results['interpretation']}")
    
    # Quadrat analysis
    quadrat_results = quadrat_analysis(x, y, n_quadrats_x=8, n_quadrats_y=8)
    print(f"\nQuadrat Analysis:")
    print(f"  VMR: {quadrat_results['vmr']:.3f}")
    print(f"  Interpretation: {quadrat_results['interpretation']}")
...
print("  Figure saved as 'recipe_03_point_patterns.png'")
plt.show()
...
print("SUMMARY TABLE")
print("=" * 70)
print(f"{'Pattern':<12} {'R Index':>10} {'VMR':>10} {'Ripley':>15} {'Overall':>15}")
print("-" * 70)
...
for pattern_name in patterns.keys():
    ...
    print(f"{pattern_name:<12} {r_index:>10.3f} {vmr:>10.3f} {ripley_interp:>15} {overall:>15}")
