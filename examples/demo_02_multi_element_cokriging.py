...
def analyze_element_correlations(data):
 ...
 # Calculate correlations
    ...
    if corr_cu_mo > 0.5:
        logger.info(" Strong Cu-Mo correlation detected (typical of porphyry deposits)")
 ...
 # Remove top and right spines
    axes[0].set_title('Cu vs Mo Correlation')
...
if __name__ == '__main__':
    ...
    # Load data
    data = load_multi_element_data(AGDB_PATH)
    
    # Analyze correlations
    analyze_element_correlations(data)
    
    # Detect anomalies
    elements_dict = detect_geochemical_anomalies(data)
    
    # Compare methods
    compare_kriging_vs_cokriging(data, elements_dict)
    
    # Calculate porphyry index
    calculate_porphyry_index(data, elements_dict)
