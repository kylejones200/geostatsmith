...
def example_1_optimal_sampling():
    ...
    print("\n" + "="*60)
    print("Example 1: Optimal Sampling Design")
    print("="*60)
    
    # Initial sparse sampling
    print("Creating initial sparse sample network...")
    np.random.seed(42)
    n_initial = 20
    ...
    # Fit variogram
    print("Fitting variogram to initial data...")
    ...
    print(f"  Range: {params['range']:.2f} m")
    ...
    print("✓ Optimal locations computed for 3 strategies")
    ...
    print("✓ Saved example_workflow_02_optimal_sampling.png")
    plt.close()
...
def example_2_infill_sampling():
    ...
    print("\n" + "="*60)
    print("Example 2: Infill Sampling")
    print("="*60)
    ...
    print("Finding infill locations to reduce variance below 2.0...")
    ...
    print(f"✓ Need {len(x_infill)} additional samples")
    ...
    print("✓ Saved example_workflow_02_infill.png")
    plt.close()
...
def example_3_sample_size_calculator():
    ...
    print("\n" + "="*60)
    print("Example 3: Sample Size Calculator")
    print("="*60)
    ...
    print("Calculating required samples for target RMSE = 1.5...")
    ...
    print(f"\n✓ Results:")
    print(f"  Current samples: {n_initial}")
    print(f"  Current RMSE: {results['current_rmse']:.3f}")
    print(f"  Target RMSE: {results['target_rmse']:.3f}")
    print(f"  Required samples: {results['required_samples']}")
    print(f"  Additional needed: {results['required_samples'] - n_initial}")
    print(f"  Achievable: {'Yes' if results['achievable'] else 'No'}")
    ...
    print("✓ Saved example_workflow_02_sample_size.png")
    plt.close()
...
def example_4_cost_benefit():
    ...
    print("  Cost per sample: $500")
    print("  Benefit per RMSE reduction: $2000")
    print("  Maximum budget: $20,000")
    ...
    print(f"\n✓ Optimal Strategy:")
    print(f"  Current samples: {n_initial}")
    print(f"  Optimal total samples: {results['optimal_n_samples']}")
    print(f"  Additional samples needed: {results['optimal_n_additional']}")
    print(f"  Total cost: ${results['optimal_total_cost']:,.2f}")
    print(f"  Net benefit: ${results['optimal_net_benefit']:,.2f}")
    print(f"  Baseline RMSE: {results['baseline_rmse']:.3f}")
    print(f"  Optimal RMSE: {results['optimal_rmse']:.3f}")
    ...
    print("✓ Saved example_workflow_02_cost_benefit.png")
    plt.close()
...
def main():
    """Run all examples."""
    print("\n" + "="*70)
    print("GEOSTATS OPTIMIZATION WORKFLOW EXAMPLES")
    print("="*70)
    ...
    print("="*70)
    print("\nFiles created:")
    print("  - example_workflow_02_optimal_sampling.png")
    print("  - example_workflow_02_infill.png")
    print("  - example_workflow_02_sample_size.png")
    print("  - example_workflow_02_cost_benefit.png")
    print("\n")
