...
def plot_cross_validation(
    ...
    **kwargs
    ...
    # Scatter plot
    ax.scatter(
        y_true, y_pred, alpha=0.6, s=50, edgecolors="black", linewidth=0.5, **kwargs
    )
...
def plot_histogram(
    ...
    **kwargs
    ...
    n, bins_edges, patches = ax.hist(
        data, bins=bins, density=True, alpha=0.7, edgecolor="black", **kwargs
    )
...
def plot_obs_vs_pred(
    ...
    **kwargs
    ...
    ax.scatter(
        observed, predicted, alpha=0.6, s=60, edgecolors="black", linewidth=1, **kwargs
    )
