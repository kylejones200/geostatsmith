...
def spatial_randomness_test(
    ...
    **kwargs,
    ...
    """
    Comprehensive test for spatial randomness using multiple methods.
    ...
    **kwargs
    ...
    >>> print("Nearest Neighbor:", results['nearest_neighbor']['interpretation'])
    >>> print("Ripley's K:", results['ripley_k']['interpretation'])
    >>> print("Quadrat:", results['quadrat']['interpretation'])
...
def clustering_index(
    ...
    >>> print(f"Clustering index: {index:.3f}")
    """
