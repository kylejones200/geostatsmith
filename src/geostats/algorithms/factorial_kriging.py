...
class FactorialKriging(BaseKriging):
    ...
    def predict_components(
        ...
        for i, structure in enumerate(self.nested_variogram.structures):
            ...
            for j in range(n_pred):
                ...
                # Estimate component: Yᵢ*(x₀) = Σⱼ λⱼⁱ [Z(xⱼ) - μ]
    ...
    def predict(
        ...
        """
        components = self.predict_components(x_new, y_new)
        ...
        if return_variance:
            # Variance is sum of component variances (assuming independence)
            # This is a simplification - proper calculation requires cross-covariances
