...
def load_synthetic_dem_sample() -> Dict[str, Any]:
    ...
    >>> print(f"Sample has {len(data['x'])} sparse points")
...
def load_volcano_sample() -> Dict[str, Any]:
    ...
    >>> print(f"Peak elevation: {data['metadata']['peak_elevation']:.1f}")
...
def load_valley_sample() -> Dict[str, Any]:
    ...
    >>> print(f"Valley floor elevation: {data['metadata']['valley_floor']:.1f}")
