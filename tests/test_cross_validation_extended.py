...
class TestKFoldCrossValidation:
    def test_k_fold_basic(self):
        ...
        results = k_fold_cross_validation(
            x, y, z, OrdinaryKriging, variogram, n_folds=5
        )
...
class TestSpatialCrossValidation:
    def test_spatial_cv_basic(self):
        ...
        results = spatial_cross_validation(
            x, y, z, OrdinaryKriging, variogram, n_blocks=4
        )
    ...
    def test_spatial_cv_different_blocks(self):
        ...
        for n_blocks in [2, 4]:
            results = block_cross_validate(
                self.x, self.y, self.z, variogram_model=variogram, n_blocks=n_blocks
            )
...
class TestCrossValidationComparison:
    def test_compare_cv_methods(self):
        ...
        # K-fold
        results_kfold = k_fold_cross_validation(
            x, y, z, OrdinaryKriging, variogram, n_folds=5
        )
        ...
        # Spatial
        results_spatial = spatial_cross_validation(
            x, y, z, OrdinaryKriging, variogram, n_blocks=4
        )
